...
<div class="dlabnav">
    <div class="dlabnav-scroll">
        <ul class="metismenu" id="menu">
            <li class="dropdown header-profile">
                <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                    ...
                    <div class="header-info ms-3">
                        <span class="font-w600 ">Hola,<b> Jose</b></span>
                        <small class="text-end font-w400">Grente Gadax</small>
                    </div>
                </a>
            ...
            <li>
                <a class="ai-icon" href="inicio" aria-expanded="false">
            ...
            <li>
                <a class="ai-icon" href="solicitudes" aria-expanded="false">
                    <i class="fa-solid fa-comment"></i>
                    <span class="nav-text">Solicitudes</span>
                    <span class="badge badge-xs badge-primary ms-3">0</span>
                </a>
            </li>

            <li>
                <a class="ai-icon" href="clientes" aria-expanded="false">
            ...
            <li>
                <a class="ai-icon" href="prestamos" aria-expanded="false">
            ...
            <li>
                <a class="ai-icon" href="pagos" aria-expanded="false">
            ...
            <li>
                <a class="ai-icon" href="cajas" aria-expanded="false">
            ...
            <li>
                <a class="ai-icon" href="gastos" aria-expanded="false">
            ...
            <li>
                <a class="ai-icon" href="rutas" aria-expanded="false">
            ...
            <li>
                <a class="ai-icon" href="carteras" aria-expanded="false">
                    <i class="fa-solid fa-wallet"></i>
                    <span class="nav-text">Carteras</span>
                </a>
            </li>

            <li>
                <a class="ai-icon" href="mapa" aria-expanded="false">
            ...
            <li>
                <a class="ai-icon" href="plantillas" aria-expanded="false">
            ...
            <li>
                <a class="ai-icon" aria-expanded="false" style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#theModal">
            ...
            <li>
                <a class="ai-icon" href="ayuda" aria-expanded="false">
